...
if __name__ == "__main__":
    ...
    autotest_scripts['user2'] = small_talk + ["none", "60min", "chicken", "No"]
    # liked_recipes = dict()
    ...
    #
    liked_recipes = dict()
    liked_recipes['user2'] = [ "9615/healthy-banana-cookies/", "11032/oatmeal-craisin-cookies/", "8533/quick-chicken-divan/", "11800/fettuccini-with-mushroom-ham-and-rose-sauce/", "34159/spicy-oven-fried-chicken/" ]
