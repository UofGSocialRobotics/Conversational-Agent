...
if __name__ == "__main__":
    ...
    autotest_scripts["always_says_no"] = ["hello", "good and u?", " I ll be hungry, i m always hungry for dinner", "the healthier the better" , "nop", "I have time", " i have fish in the fridge that s going to go bad if i don t cook it today", "no, i don t like apples", "no", "no", "no"]
