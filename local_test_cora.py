...
if __name__ == "__main__":
    ...
    autotest_scripts["error_pop_from_empty_list"] = ["hiya", "Lucile", "exhausted", "I live in Paris", "I depends, pasta most of the time.", "It's easy to make.", "i am hungry", "very healthy", 'i dont eat dairy', "I have pabout 20 min", "Not that", "sure", "i don t like salad", "something else", "no", "no", "no"]
