...
print(Anova(model, type = 'II'))
model = lm(health.score.learn.pref ~ health_influence_str, data = df_tags)
print(Anova(model, type = 'II'))
...
```{r}
model = lm(f1 ~ health_important_str, data = df_tags)
print(Anova(model, type = 'II'))
model = lm(health.score.learn.pref ~ health_important_str, data = df_tags)
print(Anova(model, type = 'II'))
model = lm(health.score.eval ~ health_important_str, data = df_tags)
print(Anova(model, type = 'II'))
model = lm(satisfaction ~ health_important_str, data = df_tags)
print(Anova(model, type = 'II'))
model = lm(easiness ~ health_important_str, data = df_tags)
print(Anova(model, type = 'II'))
...
print(Anova(model, type = 'II'))
model = lm(health.score.learn.pref ~ health_important_str, data = mydata)
print(Anova(model, type = 'II'))
