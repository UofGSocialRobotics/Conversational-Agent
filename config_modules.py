...
class Modules:
    ...
    def set_domain(self, domain):
        if domain == "movies":
            ...
            NLG_config = {"module": food_NLG.NLG, "name": "NLG", "subscribes": config.NLG_subscribes, "publishes": config.NLG_publishes, "tags_explanation_types": config.EXPLANATION_TYPE, "cs": config.exp_cs_human}
            # SA_config = {"module": movies_SA.SentimentAnalysis, "name": "SA", "subscribes": config.SentimentAnalysis_subscribes, "publishes": config.SentimentAnalysis_publishes}
